  ...
  return (
    <div className="page">
      <div className="page__box">
        <Header/>
        <Main onEditAvatar={handleEditAvatarClick} onEditProfile={handleEditProfileClick} onAddPlace={handleAddPlaceClick} onDeletePlace={handleDeletePlaceClick} onCardClick={handleCardClick}/>
        <Footer/>
      </div>
